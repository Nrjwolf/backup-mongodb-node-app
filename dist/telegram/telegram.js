...
exports.bot = new node_telegram_bot_api_1.default(env_1.ENV.TELEGRAM_BOT_TOKEN, { polling: true });
...
var onMessage = function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (((_a = msg.from) === null || _a === void 0 ? void 0 : _a.id.toString()) != env_1.ENV.ADMIN_TELEGRAM_ID)
                    return [2 /*return*/];
                if (msg.text == '/start') {
            ...
            case 2:
                ...
                telegram_url = "https://api.telegram.org/file/bot" + env_1.ENV.TELEGRAM_BOT_TOKEN + "/" + telegram_file.file_path;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, exports.bot.sendMessage(env_1.ENV.TELEGRAM_CHAT_TO_LOG, text, options)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, exports.bot.sendDocument(env_1.ENV.TELEGRAM_CHAT_TO_LOG, path, { parse_mode: 'HTML', caption: caption }, fileOptions)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
